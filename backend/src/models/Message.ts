...
export interface IMessage extends Document {
  ...
  automationSource?: 'comment_dm' | 'auto_reply' | 'followup' | 'template_flow' | 'ai_reply';  // Source of automated message
...
const messageSchema = new Schema<IMessage>({
  ...
  automationSource: {
    type: String,
    enum: ['comment_dm', 'auto_reply', 'followup', 'template_flow', 'ai_reply'],
    sparse: true,
  },
